...
static PyMethodDef set_methods[] = {
    ...
    {"__reduce__", set_reduce, METH_NOARGS,
     PyDoc_STR("Pickle support: reconstruct from dtype and elements.")},
...
static PyMethodDef map_methods[] = {
    ...
    {"__reduce__", map_reduce, METH_NOARGS,
     PyDoc_STR("Pickle support: reconstruct from dtypes; items are applied after creation.")},
    {"__class_getitem__", Py_GenericAlias, METH_O | METH_CLASS,
     PyDoc_STR("See PEP 585: parameterized generic alias support (e.g. Set[int]).")},
    {nullptr, nullptr, 0, nullptr},
};
...
static PyMethodDef vector_methods[] = {
    ...
    {"__reduce__", vec_reduce, METH_NOARGS,
     PyDoc_STR("Pickle support: reconstruct from dtype; elements are applied after creation.")},
    {"__class_getitem__", Py_GenericAlias, METH_O | METH_CLASS,
     PyDoc_STR("See PEP 585: parameterized generic alias support (e.g. Set[int]).")},
    {nullptr, nullptr, 0, nullptr},
};
