...
class RuntimeImpl(Runtime):
    ...
    class _Side(ta.Generic[FactoryT, FactoryContextT, HandlerT]):
        def __init__(
            ...
            self.entries: dict[ta.Any, RuntimeImpl._Entry[HandlerT]] = {}
    ...
    def _make_locked(
        ...
        side.entries[ek] = RuntimeImpl._Entry(h, deps, gen)
...
def make_runtime(
    ...
    return RuntimeImpl(
        ...
        marshaler_factory=marshaler_factory,
        unmarshaler_factory=unmarshaler_factory,
    )
