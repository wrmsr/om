...
@_register(
    ...
    cls_names=(
        ('omcore.marshal.polymorphism.specs', 'ConfigSubtypeSource'),
        ('omcore.marshal.polymorphism.specs', 'ManifestSubtypeSource'),
        ('omcore.marshal.polymorphism.specs', 'SubclassesSubtypeSource'),
    ),
)
...
@_register(
    plan_repr=(
        "Plans(tup=(CopyPlan(fields=('subtypes',)), EqPlan(fields=('subtypes',)), FrozenPlan(fields=('subtypes',), allo"
        "w_dynamic_dunder_attrs=False), HashPlan(action='add', fields=('subtypes',), cache=False), InitPlan(fields=(Ini"
        "tPlan.Field(name='subtypes', annotation=OpRef(name='init.fields.0.annotation'), default=None, default_factory="
        "None, init=True, override=False, field_type=FieldType.INSTANCE, coerce=None, validate=None, check_type=None),)"
        ", self_param='self', std_params=('subtypes',), kw_only_params=(), frozen=True, slots=False, post_init_params=N"
        "one, init_fns=(), validate_fns=()), ReprPlan(fields=(ReprPlan.Field(name='subtypes', kw_only=False, fn=None),)"
        ", id=False, terse=False, default_fn=None)))"
    ),
    plan_repr_sha1='9c3bcc8021de5324a28d0ac1da7c20885dcc03c6',
    cls_names=(
        ('omcore.marshal.polymorphism.specs', 'ExplicitSubtypeSource'),
    ),
)
def _process_dataclass__9c3bcc8021de5324a28d0ac1da7c20885dcc03c6():
    def _process_dataclass(
        *,
        __class__,
        __dataclass__init__fields__0__annotation,
        ...
        def __init__(
            self,
            subtypes: __dataclass__init__fields__0__annotation,
        ) -> __dataclass__None:
            __dataclass__object_setattr(self, 'subtypes', subtypes)
        ...
        def __repr__(self):
            parts = []
            parts.append(f"subtypes={self.subtypes!r}")
            return (
                f"{self.__class__.__qualname__}("
                f"{', '.join(parts)}"
                f")"
