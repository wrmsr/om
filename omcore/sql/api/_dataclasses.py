...
@_register(
    installer_sha1='f707c5f722747b9f5bf1bdd8e8120f73f21d0b1a',
    spec_keys=(
        (
            ...
            " False, False, False), (('adapter', True, True, None, True, True, False, None), 'instance', 'value', None,"
...
def _process_dataclass__f707c5f722747b9f5bf1bdd8e8120f73f21d0b1a():
...
@_register(
    installer_sha1='c735d0bab047bbb6ea9fe052b1212cd31cb545f6',
    spec_keys=(
        (
            ...
            "one, False, False, False), (('db_type', True, True, None, True, True, False, None), 'instance', 'value', N"
            "one, False, False, False), (('type', True, True, None, True, True, False, None), 'instance', 'value', None"
            ", False, False, False)), False, 0, ()), (False, False, (), False, (False, False, ()), (), (), False))"
        ),
    ),
    cls_names=(
...
def _process_dataclass__c735d0bab047bbb6ea9fe052b1212cd31cb545f6():
    def _process_dataclass(
        __class__,
        __dataclass__spec,
        __dataclass__ctx,
...
@_register(
    installer_sha1='4f3791c3b2a5406e973759e49a2d906a2e9bb89c',
    spec_keys=(
        (
            "(((True, True, True, False, False, True, True, False, False, False, False, False, False, False, False, Fal"
            "se, False, False, False), ((('rows', True, True, None, True, False, False, None), 'instance', 'missing', N"
...
def _process_dataclass__4f3791c3b2a5406e973759e49a2d906a2e9bb89c():
    def _process_dataclass(
        __class__,
        __dataclass__spec,
        __dataclass__ctx,
...
@_register(
    ...
    spec_keys=(
        (
            "(((True, True, True, False, False, True, True, False, False, False, False, False, False, False, False, Fal"
            "se, False, False, False), (), False, 0, ()), (False, False, (), False, (True, False, ()), (), (), False))"
        ),
    ),
    cls_names=(
...
@_register(
    installer_sha1='135637c62b315b95b8a1a8d7721e34d1e105b5fe',
    spec_keys=(
        (
            "(((True, True, True, False, False, True, True, False, False, False, False, False, False, False, False, Fal"
...
def _process_dataclass__135637c62b315b95b8a1a8d7721e34d1e105b5fe():
    def _process_dataclass(
        __class__,
        __dataclass__spec,
        __dataclass__ctx,
...
@_register(
    installer_sha1='31a53c5206a716c6676581fee28ab00580a2a7a6',
    spec_keys=(
        (
            "(((True, True, True, False, False, True, True, False, False, False, False, False, False, False, False, Fal"
            "se, False, False, False), ((('columns', True, True, None, True, False, False, None), 'instance', 'missing'"
            ", None, False, False, False), (('values', True, True, None, True, False, False, None), 'instance', 'missin"
            "g', None, False, False, False)), False, 0, ()), (False, False, (), False, (False, True, ()), (), (), False"
            "))"
        ),
    ),
    cls_names=(
...
def _process_dataclass__31a53c5206a716c6676581fee28ab00580a2a7a6():
    def _process_dataclass(
        __class__,
        __dataclass__spec,
        __dataclass__ctx,
