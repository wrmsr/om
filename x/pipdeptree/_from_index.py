...
def _resolve_indexes(index_url: str | None, extra_index_url: list[str] | None) -> list[tuple[str, str]] | None:
    ...
    from nab_python.fetch import DEFAULT_INDEX_NAME  # noqa: PLC0415
    from nab_python.fetch import DEFAULT_INDEX_URL  # noqa: PLC0415
...
def _resolve_pyproject_path(pyproject: Path, indexes: list[tuple[str, str]] | None) -> Any:
    ...
    try:
        ...
        from nab_index.urllib3_async_transport import Urllib3AsyncTransport  # noqa: PLC0415
