...
def test_render_text_default_unchanged(example_dag: PackageDAG, capsys: pytest.CaptureFixture[str]) -> None:  # noqa
...
def test_render_json_default_unchanged(example_dag: PackageDAG, capsys: pytest.CaptureFixture[str]) -> None:  # noqa
