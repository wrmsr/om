...
The :func:`render` function lets you obtain the dependency tree as a string from within Python -- e.g. a Jupyter or
JupyterLite cell -- without going through the command line or capturing stdout yourself::
...
_BINARY_GRAPHVIZ_FORMATS = frozenset({
    'png',
    'svg',
    'pdf',
    'jpeg',
