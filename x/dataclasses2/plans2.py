...
class SPECIAL_SPEC_VAL_PART(lang.Marker, lang.Abstract):  # noqa
    pass


class MUST(SPECIAL_SPEC_VAL_PART):  # noqa
    pass


class GET_FIELD_ANN(SPECIAL_SPEC_VAL_PART):  # noqa
    pass


class GET_GENERIC_FIELD_ANN(SPECIAL_SPEC_VAL_PART):  # noqa
    pass


SpecValPart = ta.Union[  # noqa
    str,  # attr
    int,  # idx
    type[SPECIAL_SPEC_VAL_PART],
]


@ta.final
class SpecVal:
    def __init__(self, *parts: SpecValPart) -> None:
        self._parts = parts
...
class InitGenerator(Generator[InitPlan]):
    ...
    def plan(self, ctx: ProcessingContext) -> PlanResult[InitPlan] | None:
        ...
        for i, validate_fn in enumerate(validate_fns):
            ...
            orm[validate_fn_ref] = SpecVal('validate_fns', i)
    ...
    def plan(self, ctx: ProcessingContext) -> PlanResult[ReprPlan] | None:
        ...
        for i, f in enumerate(fs):
            ...
            if f.repr_fn is not None:
                ...
                # orm[fnr] = f.repr_fn
                orm[fnr] = SpecVal('fields', ctx.cs.field_indexes_by_name[f.name], 'repr_fn')
        ...
        if ctx.cs.default_repr_fn is not None:
            ...
            orm[drf] = SpecVal('default_repr_fn')
