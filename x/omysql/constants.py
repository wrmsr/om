...
class CLIENT(lang.Namespace):  # noqa
...
class COMMAND(lang.Namespace):  # noqa
    COM_SLEEP = 0x00
    COM_QUIT = 0x01
    COM_INIT_DB = 0x02
    COM_QUERY = 0x03
...
class FIELD_TYPE(lang.Namespace):  # noqa
    DECIMAL = 0
    TINY = 1
    SHORT = 2
    LONG = 3
...
class FLAG(lang.Namespace):  # noqa
    NOT_NULL = 1
    PRI_KEY = 2
    UNIQUE_KEY = 4
    MULTIPLE_KEY = 8
...
class SERVER_STATUS(lang.Namespace):  # noqa
