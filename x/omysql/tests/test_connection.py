...
class TestConnection(base.PyMySQLTestCase):
    ...
    def test_ssl_connect(self):
        ...
        with mock.patch(
            "omysql.connections.ssl.create_default_context",
        ...
        with mock.patch(
            ...
            conn = omysql.connect(defer_connect=True)
            assert create_default_context.called
    ...
    def test_ssl_required_error(self):
        ...
        with mock.patch(
            ...
            conn = omysql.connect(ssl_ca="ca", defer_connect=True)
