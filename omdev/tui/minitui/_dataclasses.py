...
@_register(
    plan_repr=(
        "Plans(tup=(CopyPlan(fields=('number', 'speaker', 'text')), EqPlan(fields=('number', 'speaker', 'text')), Froze"
        "nPlan(fields=('number', 'speaker', 'text'), allow_dynamic_dunder_attrs=False), HashPlan(action='add', fields=("
        "'number', 'speaker', 'text'), cache=False), InitPlan(fields=(InitPlan.Field(name='number', annotation=OpRef(na"
        "me='init.fields.0.annotation'), default=None, default_factory=None, init=True, override=False, field_type=Fiel"
        "dType.INSTANCE, coerce=None, validate=None, check_type=None), InitPlan.Field(name='speaker', annotation=OpRef("
        "name='init.fields.1.annotation'), default=None, default_factory=None, init=True, override=False, field_type=Fi"
        "eldType.INSTANCE, coerce=None, validate=None, check_type=None), InitPlan.Field(name='text', annotation=OpRef(n"
        "ame='init.fields.2.annotation'), default=None, default_factory=None, init=True, override=False, field_type=Fie"
        "ldType.INSTANCE, coerce=None, validate=None, check_type=None)), self_param='self', std_params=('number', 'spea"
        "ker', 'text'), kw_only_params=(), frozen=True, slots=False, post_init_params=None, init_fns=(), validate_fns=("
        ")), ReprPlan(fields=(ReprPlan.Field(name='number', kw_only=False, fn=None), ReprPlan.Field(name='speaker', kw_"
        "only=False, fn=None), ReprPlan.Field(name='text', kw_only=False, fn=None)), id=False, terse=False, default_fn="
        "None)))"
    ),
    ...
    def _process_dataclass(
        *,
        ...
        def __init__(
            ...
            speaker: __dataclass__init__fields__1__annotation,
