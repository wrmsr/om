...
renderers. `render_diff_ansi()` is the terminal adapter; it resolves the diff theme through minitui and emits a complete
ANSI string synchronously, without a screen, surface, driver, or event loop.
