...
def __om_amalg__():  # noqa
    return dict(
        src_files=[
            ...
            dict(path='../streambufs/framing.py', sha1='27e2ae2a24b557b6ae696f8982eac517b4617e99'),
            ...
            dict(path='../streambufs/segmented.py', sha1='c4f0809d61172e2f1d035127582a08a1cfcbff77'),
