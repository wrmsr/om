...
class ProcOption(tv.TypedValue, lang.Abstract):
    pass


ProcOptions: ta.TypeAlias = tv.TypedValues[ProcOption]


def layer_options(base: ProcOptions | None, *overrides: ta.Iterable[ProcOption] | None) -> ProcOptions:
...
class TerminationPolicy(tv.UniqueTypedValue, ProcOption, lang.Final):
...
@ta.final
@dc.dataclass(frozen=True, kw_only=True)
class SpoolPolicy(tv.UniqueTypedValue, ProcOption, lang.Final):
...
@ta.final
@dc.dataclass(frozen=True, kw_only=True)
class SessionMode(tv.UniqueTypedValue, ProcOption, lang.Final):
...
@ta.final
@dc.dataclass(frozen=True, kw_only=True)
class Credentials(tv.UniqueTypedValue, ProcOption, lang.Final):
...
class Umask(tv.UniqueScalarTypedValue[int], ProcOption, lang.Final):
    pass


@ta.final
@dc.dataclass(frozen=True)
class Rlimit(ProcOption, lang.Final):
...
@ta.final
@dc.dataclass(frozen=True, kw_only=True)
class Deathsig(tv.UniqueTypedValue, ProcOption, lang.Final):
...
@ta.final
@dc.dataclass(frozen=True)
class Tag(tv.ScalarTypedValue[str], ProcOption, lang.Final):
