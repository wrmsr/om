...
@_register(
    installer_sha1='88946816e9bf45643e85d8c3955e69ec3165dc3a',
    spec_keys=(
        (
            ...
            ", None, False, False, False), (('timeout_s', True, True, None, True, False, False, None), 'instance', 'mis"
            "sing', None, False, False, False)), False, 0, ()), ((False,), (False,), (), (False,), (False, False, ()), "
            "((),), (), (False,)))"
        ),
    ),
    cls_names=(
        ('omllm.agent.web.backends.duckduckgo.search', '_SearchJob'),
    ),
)
def _process_dataclass__88946816e9bf45643e85d8c3955e69ec3165dc3a():
    def _process_dataclass(
        ...
        def __init__(
            ...
            timeout_s: __dataclass__init__fields__1__annotation,
        ) -> __dataclass__None:
...
@_register(
    ...
    spec_keys=(
        (
            ...
            "e, False, False, False)), False, 0, (('self',),)), ((False,), (False,), (), (False,), (False, False, ()), "
            "((),), (), (False,)))"
        ),
    ),
    cls_names=(
