...
@_register(
    plan_repr=(
        ...
        ", self_param='self', std_params=(), kw_only_params=('dir_path',), frozen=True, slots=False, post_init_params=N"
        "one, init_fns=(), validate_fns=()), ReprPlan(fields=(ReprPlan.Field(name='dir_path', kw_only=True, fn=None),),"
